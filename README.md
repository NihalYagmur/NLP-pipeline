...
+ final.py is the file with the final structure (contains pos-tags,named entity recognition, ccg-tags referring to ontospace ontology and the grammar library.)
